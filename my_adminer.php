è4ædÝÐ¥â>'â¼ýÇKR<r`¿ã½‡/\\¹Ç¾Aä\\Æ äŸâ@Åâ’ÙäÀ¾‚çã°}1.2ä}ä½'æþk1ý¹ç|Ò7þqË>uÓžmè+cç¾Ïül\0Ïç'á^™.>êçÓÒswêÜ‰.>¥6ž¶Ãþ‡.>—6„kMç¾¿ÆÞÏí='ÏL>\0Œ^éÙ’K6Ý'ïó7ÒÉì3+ïœËé)5sHÃ’ÈºÜJ\r’²=ýÑ-}#ýí)B?,Œ¦Ê´T-?+ÝÞo72\$òS'¿1²‘Æ^Ÿì_8KÞýôóí¿G1`aÎòhÃ_\rè}ê3‡õ^ºþ¹ÑþÉÓCk¶˜oÕƒ£÷^øÂ%ø»÷?Oê~±ùr\rÿ¡ÆÓ._ [û;ñçÂóò2óÄ<GÄ¢/ü\\EaòÉËþ¯Æ•Æž{ýKÇ_ÜKÜ|—œåÈ]CÈ¾{É•Éž	àÃ±‡v:¡ÝÏÑ~[ÖRòåç<õ2î±yû›Ý÷\0×Î¾‰ëhL«Ô’Šço…Ô;àn€¦Sˆ§'=9ñîÏ¾t£¥é7BÀRÎŠdc£E×ß¿IíIÃ3’\"ó×O7Áøo=uJî²Î»µæ‰MvsÀîë¸#½IÖîÂ‚;Òà–Ç‘ºÝØÎÈ,ãQÚüGW;Bîßv»® ¶í˜.Á9ÛÐ`xs±œJîBk%œ©i|sÜ]–îçV»ÅÞ`_w¬ÝÀï„¦»é1á*wì¨ë8#Aüï2«QŸý0‰;Uè°a€„B@ò·Œ¼½)¯I[Ë\\îçŽ•ãÏ0yC–àþ÷“Âj\n/*xÃË^4ó™?y÷o½~sÚÞŽûw«½•ÆÉÀzá?HZ=%íð~sÕ^Åg%Bú»…’\\_SžÃp·~sëÇçIÃ9éO*{ˆžæ÷Ww=é÷pÚóàt›Ç¿„ú‰ÁK›áJççÄ&qñPjƒd\$’výwU	EÎ¯“JkåBÌùs-QóO¦Sçß›—è>•()‹}Kóa÷×ˆ˜O²pP¨iÞBý÷Ò~jm!Xçwà]¹î K#«_ë(¿),‰s~œbJéH“¿VÝ~È·Ã€R@Ž´	€’Ž£+˜¸€S\\pFŠø«Ô¦%å5	ŸbfÓN%Ãsˆ¬D¡Û~\"Îš'Â¿i\na³");}elseif($_GET["file"]=="functions.js"){header("Content-Type: text/javascript; charset=utf-8");echo
...
as$s=>$jb){$jc=$Rb[$jb];if(!isset($jc))$jc=$ui.$ui[0];$J.=$jc;if($s)$Rb[]=$ui.$jc[0];$ui=$jc;}return$J;}function
...
false;}libxml_use_internal_errors(true);$vi=simplexml_load_string($Jc);if(!$vi){$n=libxml_get_last_error();$g->error=$n->message;return
false;}if($vi->Errors){$n=$vi->Errors->Error;$g->error="$n->Message ($n->Code)";return
false;}$g->error='';$nh=$va."Result";return($vi->$nh?$vi->$nh:true);}function
sdb_request_all($va,$nh,$F=array(),$wh=0){$J=array();$Vg=($wh?microtime(true):0);$z=(preg_match('~LIMIT\s+(\d+)\s*$~i',$F['SelectExpression'],$B)?$B[1]:0);do{$vi=sdb_request($va,$F);if(!$vi)break;foreach($vi->$nh
as$jc)$J[]=$jc;if($z&&count($J)>=$z){$_GET["next"]=$vi->NextToken;break;}if($wh&&microtime(true)-$Vg>$wh)return
false;$F['NextToken']=$vi->NextToken;if($z)$F['SelectExpression']=preg_replace('~\d+\s*$~',$z-count($J),$F['SelectExpression']);}while($vi->NextToken);return$J;}$x="simpledb";$Ye=array("=","<",">","<=",">=","!=","LIKE","LIKE %%","IN","IS NULL","NOT LIKE","IS NOT NULL");$Zc=array();$ed=array("count");$gc=array(array("json"));}$Yb["mongo"]="MongoDB (beta)";if(isset($_GET["mongo"])){$Hf=array("mongo");define("DRIVER","mongo");if(class_exists('MongoDB')){class
...
tableName($fh){return
h($fh["Name"]);}function
fieldName($o,$df=0){if($o["is_virtual"])return'<span title="'.h($o["full_type"]).'">'.h($o["field"]).'</span>';else
...
long2str($W,$ri){$vg='';foreach($W
as$X)$vg.=pack('V',$X);if($ri)return
substr($vg,0,end($W));return$vg;}function
str2long($vg,$ri){$W=array_values(unpack('V*',str_pad($vg,4*ceil(strlen($vg)/4),"\0")));if($ri)$W[]=strlen($vg);return$W;}function
xxtea_mx($xi,$wi,$ch,$Kd){return
int32((($xi>>5&0x7FFFFFF)^$wi<<2)+(($wi>>3&0x1FFFFFFF)^$xi<<4))^int32(($ch^$wi)+($Kd^$xi));}function
encrypt_string($Xg,$y){if($Xg=="")return"";$y=array_values(unpack("V*",pack("H*",md5($y))));$W=str2long($Xg,true);$Ce=count($W)-1;$xi=$W[$Ce];$wi=$W[0];$Tf=floor(6+52/($Ce+1));$ch=0;while($Tf-->0){$ch=int32($ch+0x9E3779B9);$fc=$ch>>2&3;for($pf=0;$pf<$Ce;$pf++){$wi=$W[$pf+1];$Be=xxtea_mx($xi,$wi,$ch,$y[$pf&3^$fc]);$xi=int32($W[$pf]+$Be);$W[$pf]=$xi;}$wi=$W[0];$Be=xxtea_mx($xi,$wi,$ch,$y[$pf&3^$fc]);$xi=int32($W[$Ce]+$Be);$W[$Ce]=$xi;}return
long2str($W,false);}function
decrypt_string($Xg,$y){if($Xg=="")return"";if(!$y)return
false;$y=array_values(unpack("V*",pack("H*",md5($y))));$W=str2long($Xg,false);$Ce=count($W)-1;$xi=$W[$Ce];$wi=$W[0];$Tf=floor(6+52/($Ce+1));$ch=int32($Tf*0x9E3779B9);while($ch){$fc=$ch>>2&3;for($pf=$Ce;$pf>0;$pf--){$xi=$W[$pf-1];$Be=xxtea_mx($xi,$wi,$ch,$y[$pf&3^$fc]);$wi=int32($W[$pf]-$Be);$W[$pf]=$wi;}$xi=$W[$Ce];$Be=xxtea_mx($xi,$wi,$ch,$y[$pf&3^$fc]);$wi=int32($W[0]-$Be);$W[0]=$wi;$ch=int32($ch-0x9E3779B9);}return
...
as$C=>$o){if($o["is_virtual"]){unset($p[$C]);continue;}if(!isset($o["privileges"][$Zh?"update":"insert"])||$b->fieldName($o)=="")unset($p[$C]);}if($_POST&&!$n&&!isset($_GET["select"])){$A=$_POST["referer"];if($_POST["insert"])$A=($Zh?null:$_SERVER["REQUEST_URI"]);elseif(!preg_match('~^.+&select=.+$~',$A))$A=ME."select=".urlencode($a);$w=indexes($a);$Uh=unique_array($_GET["where"],$w);$Wf="\nWHERE $Z";if(isset($_POST["delete"]))queries_redirect($A,lang(158),$Xb->delete($a,$Wf,!$Uh));else{$O=array();foreach($p
...
reset($J->fetch_row());}exit;}if($_POST&&!$n){$ti=$Z;if(!$_POST["all"]&&is_array($_POST["check"])){$eb=array();foreach($_POST["check"]as$bb)$eb[]=where_check($bb,$p);$ti[]="((".implode(") OR (",$eb)."))";}$ti=($ti?"\nWHERE ".implode(" AND ",$ti):"");$Kf=$Xh=null;foreach($w
as$v){if($v["type"]=="PRIMARY"){$Kf=array_flip($v["columns"]);$Xh=($M?$Kf:array());break;}}foreach((array)$Xh
as$y=>$X){if(in_array(idf_escape($y),$M))unset($Xh[$y]);}if($_POST["export"]){cookie("adminer_import","output=".urlencode($_POST["output"])."&format=".urlencode($_POST["format"]));dump_headers($a);$b->dumpTable($a,"");if(!is_array($_POST["check"])||$Xh===array())$H="SELECT $Yc$ti$dd";else{$Th=array();foreach($_POST["check"]as$X)$Th[]="(SELECT".limit($Yc,"\nWHERE ".($Z?implode(" AND ",$Z)." AND ":"").where_check($X,$p).$dd,1).")";$H=implode(" UNION ALL ",$Th);}$b->dumpData($a,"table",$H);exit;}if(!$b->selectEmailProcess($Z,$Tc)){if($_POST["save"]||$_POST["delete"]){$I=true;$za=0;$O=array();if(!$_POST["delete"]){foreach($e
as$C=>$X){$X=process_input($p[$C]);if($X!==null&&($_POST["clone"]||$X!==false))$O[idf_escape($C)]=($X!==false?$X:idf_escape($C));}}if($_POST["delete"]||$O){if($_POST["clone"])$H="INTO ".table($a)." (".implode(", ",array_keys($O)).")\nSELECT ".implode(", ",$O)."\nFROM ".table($a);if($_POST["all"]||($Xh===array()&&is_array($_POST["check"]))||$Ed){$I=($_POST["delete"]?$Xb->delete($a,$ti):($_POST["clone"]?queries("INSERT $H$ti"):$Xb->update($a,$O,$ti)));$za=$g->affected_rows;}else{foreach((array)$_POST["check"]as$X){$si="\nWHERE ".($Z?implode(" AND ",$Z)." AND ":"").where_check($X,$p);$I=($_POST["delete"]?$Xb->delete($a,$si,1):($_POST["clone"]?queries("INSERT".limit1($H,$si)):$Xb->update($a,$O,$si)));if(!$I)break;$za+=$g->affected_rows;}}}$se=lang(242,$za);if($_POST["clone"]&&$I&&$za==1){$Wd=last_id();if($Wd)$se=lang(160," $Wd");}queries_redirect(remove_from_uri($_POST["all"]&&$_POST["delete"]?"page":""),$se,$I);if(!$_POST["delete"]){edit_form($a,$p,(array)$_POST["fields"],!$_POST["clone"]);page_footer();exit;}}elseif(!$_POST["import"]){if(!$_POST["val"])$n=lang(243);else{$I=true;$za=0;foreach($_POST["val"]as$Vh=>$K){$O=array();foreach($K
