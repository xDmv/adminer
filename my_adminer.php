...
tableName($fh){return
h($fh["Name"]);}function
fieldName($o,$df=0){if($o["is_virtual"])return'<span title="'.h($o["full_type"]).'">'.h($o["field"])."(Not Edit!)".'</span>';else
